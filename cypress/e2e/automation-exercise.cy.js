...
describe('Automation Exercise', () =>{
  ...
  it('Test Case 6: Formulário de contato', () => {
      ...
      contato.preencherFormularioContato('LadyBug', 'ladybug@teste.com', 'mensagem para entrar em contato')
      
      // validação de envio de formulário com sucesso
      assercao.validarExibicaoMensagem('Success! Your details have been submitted successfully.')
